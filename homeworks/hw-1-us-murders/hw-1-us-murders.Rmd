...
4. Write a report for your friend reminding her that the US is a large and diverse country with 50 very different states as well as the District of Columbia (DC). Recommend some state for each friend knowing that some like hiking, others would like to be close to several large cosmopolitan cities.
