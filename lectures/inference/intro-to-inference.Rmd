...
ubiquitous in data science: _confidence intervals_, and _p-values_. Finally, to understand probabilistic statetmets about the probability of a candidate winning we will have to learn about Bayesian modelling. In the final sections we put it all together to recreate the simplified version of the Fivethirtyeight model and apply it to 2016 election. 
