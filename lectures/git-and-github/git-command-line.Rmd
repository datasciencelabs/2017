...
change directories into your BST 260 folder.
...
directory. It should look something like this (note that this screenshot is from last year's course and contains HW2 and 2016):
...
because I created these two files in the homework repository. (Again, this is from last year's course. You would see files relating to HW1 and 2017).
