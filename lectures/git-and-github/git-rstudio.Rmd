...
We will be using 
git and GitHub to get your homework assignments, work on your homework, 
and submit your homework solutions. This tutorial will walk you through 
that process using git and GitHub through RStudio (see the other [tutorial](https://github.com/datasciencelabs/2017/blob/master/lectures/git-and-github/git-command-line.Rmd) for using git and GitHub through the command line).
...
up to the due date at 11:59 pm as the final version. 
