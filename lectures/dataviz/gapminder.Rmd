...
To understand the smooth densities we have to understand _estimation_, a topic we don't cover until later. However, we provide a heuristic explanation to help you understand the basics and you can use this useful data visualization tool.
