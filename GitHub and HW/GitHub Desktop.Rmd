---
title: Homework with Git and GitHub Using GitHub Desktop
...
see what is in store. The work flow will be pretty simple. Note that we are using an example repository from 2016 for this example. 
...
3. Click the 'clone or download' green button.

4. Click 'open in Desktop'

 <center><img src="./images/clone_button.png" alt="gitclean" style="width: 700px;"/></center>


5. Save the repository in your BST 260 folder.

 <center><img src="./images/choose_repo.png" alt="gitclean" style="width: 700px;"/></center>
...
time to `commit/push`. After some work, if you head back to `GitHub Desktop`, 
you will see that something has changed:

 <center><img src="./images/commit.png" alt="gitclean" style="width: 700px;"/></center>

You will notice that the homework file is selected and that the changes you made are shown.  (Again, this is from last year's course. You would see files relating to HW1 and 2017).
In order to get git to save these changes on these files we need to 
`commit` them. This is equivalent to `save` in most programs. But what is special 
...
our work to Github by clicking the 'push to origin' button at the top. Note, we can (and should) do this as many times as 
...
<center><img src="./images/push.png" alt="gitclean" style="width: 700px;"/></center>
...
2. Commit changes to your local repository: `commit`
3. Push the changes to your github repo: `push`
